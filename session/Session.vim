...
nnoremap <silent> <Plug>(ctrlp) :CtrlPLastMode
...
set pastetoggle=<F7>
set ruler
set runtimepath=~/.vim,~/.config/vim/bundle/Vundle.vim,~/.config/vim/bundle/vim-fugitive,~/.config/vim/bundle/vim-devicons,~/.config/vim/bundle/nerdtree,~/.config/vim/bundle/nerdtree-git-plugin,~/.config/vim/bundle/undotree,~/.config/vim/bundle/vim-airline,~/.config/vim/bundle/vim-airline-themes,~/.config/vim/bundle/vim-colors-solarized,~/.config/vim/bundle/vim-atom-dark,~/.config/vim/bundle/papercolor-theme,~/.config/vim/bundle/yajs.vim,~/.config/vim/bundle/ctrlp.vim,~/.config/vim/bundle/vim-signature,~/.config/vim/bundle/grep,~/.config/vim/bundle/ack.vim,~/.config/vim/bundle/ctrlsf.vim,~/.config/vim/bundle/vim-multiple-cursors,~/.config/vim/bundle/nerdcommenter,~/.config/vim/bundle/vim-protodef,~/.config/vim/bundle/nginx.vim,~/.config/vim/bundle/vim-surround,~/.config/vim/bundle/syntastic,~/.config/vim/bundle/neomake,~/.config/vim/bundle/tagbar,~/.config/vim/bundle/tern_for_vim,~/.config/vim/bundle/YouCompleteMe,~/.config/vim/bundle/ultisnips,~/.config/vim/bundle/vim-gitgutter,~/.config/vim/bundle/emmet-vim,~/.config/vim/
set shiftwidth=2
set shortmess=filnxtToOmrc
set showcmd
set showmatch
set showtabline=2
set softtabstop=2
